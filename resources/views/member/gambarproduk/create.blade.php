    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fas fa-plus me-2"></i>Tambah Gambar Produk
            </h5>
        </div>
        <div class="card-body">
            <form action="{{ route('member.gambarproduk.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_gambar') is-invalid @enderror"
                                   id="nama_gambar" name="nama_gambar" value="{{ old('nama_gambar') }}"
